...
<head>
	...
	<meta name="keywords"
		content="Debian, Server, Repository, Generator, Sources, Sources List, deb, deb-src, Linux, distro, distribution">
	<meta name="description"
		content="Sources List Generator for Debian. It features the official Debian repositories as well as other 3rd party repos.">
			...
			<div class="wrap">
				...
				<div style="right:0;">
					...
					<a class="github-button" href="https://github.com/beli3ver/debgen"
						...
						aria-label="Star beli3ver/debgen on GitHub">Star</a>
					|
					<script src="https://liberapay.com/beli3ver/widgets/button.js"></script><noscript><a href="https://liberapay.com/beli3ver/donate"><img alt="Donate using Liberapay" src="https://liberapay.com/assets/widgets/donate.svg"></a></noscript>
				</div>
			</div>
		</div>
		<div class="wrap">