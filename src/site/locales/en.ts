...
export const en = {
  ...
  seo: { workbenchTitle: 'DebGen Workbench', workbenchDescription: 'Build transparent Debian package source configurations and review every repository before use.', repositoryDescription: 'Review repository provenance, signing keys, packages, and Debian compatibility.', sourceDescription: 'Inspect a package source, its signing key, and supported Debian systems.', categoryDescription: 'Explore verified Debian package sources by category.' },
} satisfies SiteCopy
